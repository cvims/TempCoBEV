...
class TemporalAttFuse(TemporalFusionModel):
    def __init__(self, config):
        super(TemporalAttFuse, self).__init__(config)
    ...
    def until_fusion(
        ...
        return self.fusion_net(x, com_mask), kwargs
